...
def mlir_add(flags: argparse.Namespace, ins: List[Arg], outs: List[Arg]) -> gc_mlir.ir.Module:
    return init_i2o1_module(ins[0], ins[1], outs[0], lambda ctx, arg0, arg1: linalg.add(arg0, arg1, outs = [outs[0].get_empty_op(ctx)]))
...
def mlir_powf(flags: argparse.Namespace, ins: List[Arg], outs: List[Arg]) -> gc_mlir.ir.Module:
    ...
    return init_i2o1_module(ins[0], ins[1], outs[0], lambda ctx, arg0, arg1: linalg.powf(arg0, arg1, outs = [outs[0].get_empty_op(ctx)]))
...
def mlir_div(flags: argparse.Namespace, ins: List[Arg], outs: List[Arg]) -> gc_mlir.ir.Module:
    return init_i2o1_module(ins[0], ins[1], outs[0], lambda ctx, arg0, arg1: linalg.div(arg0, arg1, outs = [outs[0].get_empty_op(ctx)]))
...
def mlir_mul(flags: argparse.Namespace, ins: List[Arg], outs: List[Arg]) -> gc_mlir.ir.Module:
    return init_i2o1_module(ins[0], ins[1], outs[0], lambda ctx, arg0, arg1: linalg.mul(arg0, arg1, outs = [outs[0].get_empty_op(ctx)]))
