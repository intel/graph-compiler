...
//   }
 ...
 func.func @main_entry(%arg0: tensor<32x32xf32>, %arg1: tensor<32x16xf32>, %arg2: tensor<16x64xf32>) -> tensor<32x64xf32> attributes {llvm.emit_c_interface} {
    ...
    %1 = tensor.empty() : tensor<1x2x16x16xf32>
    %expanded = tensor.expand_shape %arg1 [[0, 1], [2, 3]] output_shape [2, 16, 1, 16] : tensor<32x16xf32> into tensor<2x16x1x16xf32>
    %transposed = linalg.transpose ins(%expanded : tensor<2x16x1x16xf32>) outs(%1 : tensor<1x2x16x16xf32>) permutation = [2, 0, 1, 3] 
    %2 = tensor.empty() : tensor<2x1x16x16xf32>
    %collapsed = tensor.collapse_shape %transposed [[0, 1], [2], [3]] : tensor<1x2x16x16xf32> into tensor<2x16x16xf32>
    %3 = scf.for %arg3 = %c0 to %c2 step %c1 iter_args(%arg4 = %2) -> (tensor<2x1x16x16xf32>) {
      %7 = affine.apply affine_map<(d0) -> (d0 * 16)>(%arg3)
      %extracted_slice = tensor.extract_slice %arg0[%7, 0] [16, 32] [1, 1] : tensor<32x32xf32> to tensor<16x32xf32>
      %extracted_slice_0 = tensor.extract_slice %0[%arg3, 0, 0, 0] [1, 2, 16, 16] [1, 1, 1, 1] : tensor<2x2x16x16xf32> to tensor<1x2x16x16xf32>
      %expanded_1 = tensor.expand_shape %extracted_slice [[0, 1], [2, 3]] output_shape [1, 16, 2, 16] : tensor<16x32xf32> into tensor<1x16x2x16xf32>
      %transposed_2 = linalg.transpose ins(%expanded_1 : tensor<1x16x2x16xf32>) outs(%extracted_slice_0 : tensor<1x2x16x16xf32>) permutation = [0, 2, 1, 3] 
      %collapsed_3 = tensor.collapse_shape %transposed_2 [[0, 1], [2], [3]] : tensor<1x2x16x16xf32> into tensor<2x16x16xf32>
      %extracted_slice_4 = tensor.extract_slice %arg4[%arg3, 0, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<2x1x16x16xf32> to tensor<1x1x16x16xf32>
      %collapsed_5 = tensor.collapse_shape %extracted_slice_4 [[0, 1, 2], [3]] : tensor<1x1x16x16xf32> into tensor<16x16xf32>
      %8 = linalg.batch_reduce_matmul ins(%collapsed_3, %collapsed : tensor<2x16x16xf32>, tensor<2x16x16xf32>) outs(%collapsed_5 : tensor<16x16xf32>) -> tensor<16x16xf32>
      %expanded_6 = tensor.expand_shape %8 [[0, 1, 2], [3]] output_shape [1, 1, 16, 16] : tensor<16x16xf32> into tensor<1x1x16x16xf32>
      %inserted_slice = tensor.insert_slice %expanded_6 into %arg4[%arg3, 0, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<1x1x16x16xf32> into tensor<2x1x16x16xf32>
      scf.yield %inserted_slice : tensor<2x1x16x16xf32>
    }
    %4 = tensor.empty() : tensor<32x64xf32>
    %5 = tensor.empty() : tensor<2x4x16x16xf32>
    %6:2 = scf.for %arg3 = %c0 to %c2 step %c1 iter_args(%arg4 = %5, %arg5 = %4) -> (tensor<2x4x16x16xf32>, tensor<32x64xf32>) {
      %extracted_slice = tensor.extract_slice %3[%arg3, 0, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<2x1x16x16xf32> to tensor<1x1x16x16xf32>
      %extracted_slice_0 = tensor.extract_slice %arg4[%arg3, 0, 0, 0] [1, 4, 16, 16] [1, 1, 1, 1] : tensor<2x4x16x16xf32> to tensor<1x4x16x16xf32>
      %7 = affine.apply affine_map<(d0) -> (d0 * 16)>(%arg3)
      %extracted_slice_1 = tensor.extract_slice %arg5[%7, 0] [16, 64] [1, 1] : tensor<32x64xf32> to tensor<16x64xf32>
      %collapsed_2 = tensor.collapse_shape %extracted_slice [[0], [1, 2], [3]] : tensor<1x1x16x16xf32> into tensor<1x16x16xf32>
      %8:2 = scf.for %arg6 = %c0 to %c4 step %c1 iter_args(%arg7 = %extracted_slice_0, %arg8 = %extracted_slice_1) -> (tensor<1x4x16x16xf32>, tensor<16x64xf32>) {
        %9 = affine.apply affine_map<(d0) -> (d0 * 16)>(%arg6)
        %extracted_slice_4 = tensor.extract_slice %arg2[0, %9] [16, 16] [1, 1] : tensor<16x64xf32> to tensor<16x16xf32>
        %10 = tensor.empty() : tensor<1x1x16x16xf32>
        %inserted_slice_5 = tensor.insert_slice %extracted_slice_4 into %10[0, 0, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<16x16xf32> into tensor<1x1x16x16xf32>
        %collapsed_6 = tensor.collapse_shape %inserted_slice_5 [[0], [1, 2], [3]] : tensor<1x1x16x16xf32> into tensor<1x16x16xf32>
        %extracted_slice_7 = tensor.extract_slice %arg7[0, %arg6, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<1x4x16x16xf32> to tensor<1x1x16x16xf32>
        %collapsed_8 = tensor.collapse_shape %extracted_slice_7 [[0, 1, 2], [3]] : tensor<1x1x16x16xf32> into tensor<16x16xf32>
        %11 = linalg.batch_reduce_matmul ins(%collapsed_2, %collapsed_6 : tensor<1x16x16xf32>, tensor<1x16x16xf32>) outs(%collapsed_8 : tensor<16x16xf32>) -> tensor<16x16xf32>
        %expanded_9 = tensor.expand_shape %11 [[0, 1, 2], [3]] output_shape [1, 1, 16, 16] : tensor<16x16xf32> into tensor<1x1x16x16xf32>
        %extracted_slice_10 = tensor.extract_slice %expanded_9[0, 0, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<1x1x16x16xf32> to tensor<16x16xf32>
        %inserted_slice_11 = tensor.insert_slice %expanded_9 into %arg7[0, %arg6, 0, 0] [1, 1, 16, 16] [1, 1, 1, 1] : tensor<1x1x16x16xf32> into tensor<1x4x16x16xf32>
        %inserted_slice_12 = tensor.insert_slice %extracted_slice_10 into %arg8[0, %9] [16, 16] [1, 1] : tensor<16x16xf32> into tensor<16x64xf32>
        scf.yield %inserted_slice_11, %inserted_slice_12 : tensor<1x4x16x16xf32>, tensor<16x64xf32>
      }
      %inserted_slice = tensor.insert_slice %8#0 into %arg4[%arg3, 0, 0, 0] [1, 4, 16, 16] [1, 1, 1, 1] : tensor<1x4x16x16xf32> into tensor<2x4x16x16xf32>
      %inserted_slice_3 = tensor.insert_slice %8#1 into %arg5[%7, 0] [16, 64] [1, 1] : tensor<16x64xf32> into tensor<32x64xf32>
      scf.yield %inserted_slice, %inserted_slice_3 : tensor<2x4x16x16xf32>, tensor<32x64xf32>
    }
    return %6#1 : tensor<32x64xf32>
  }

// func.func @flash_attention(%arg0: tensor<56x16x384x64xf32>, %arg1: tensor<56x16x384x64xf32>, %arg2: tensor<56x16x384x64xf32>, %arg3: tensor<56x16x384x384xf32>) -> tensor<56x16x384x64xf32> attributes {llvm.emit_c_interface} {
...
//     %tmp = tensor.empty(): tensor<4x16x16xf32>
//     %1 = scf.forall (%arg4, %arg5, %arg6) = (0, 0, 0) to (56, 16, 384) step (1, 1, 64) shared_outs(%arg7 = %0) -> (tensor<56x16x384x64xf32>) {
//       %extracted_slice = tensor.extract_slice %arg0[%arg4, %arg5, %arg6, 0] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<56x16x384x64xf32> to tensor<1x1x64x64xf32>
//       %collapsed = tensor.collapse_shape %extracted_slice [[0, 1], [2], [3]] : tensor<1x1x64x64xf32> into tensor<1x64x64xf32>
//       %extracted_slice_3 = tensor.extract_slice %0[%arg4, %arg5, %arg6, 0] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<56x16x384x64xf32> to tensor<1x1x64x64xf32>
//       %collapsed_4 = tensor.collapse_shape %extracted_slice_3 [[0, 1, 2], [3]] : tensor<1x1x64x64xf32> into tensor<64x64xf32>
//       %2 = tensor.empty() : tensor<64xf32>
//       %3 = tensor.empty() : tensor<64xf32>
//       %4 = linalg.fill ins(%cst_1 : f32) outs(%2 : tensor<64xf32>) -> tensor<64xf32>
//       %5 = linalg.fill ins(%cst_2 : f32) outs(%3 : tensor<64xf32>) -> tensor<64xf32>
//       %6 = linalg.fill ins(%cst_2 : f32) outs(%collapsed_4 : tensor<64x64xf32>) -> tensor<64x64xf32>
//       %7:3 = scf.for %arg8 = %c0 to %c384 step %c64 iter_args(%arg9 = %6, %arg10 = %4, %arg11 = %5) -> (tensor<64x64xf32>, tensor<64xf32>, tensor<64xf32>) {
//         %extracted_slice_5 = tensor.extract_slice %arg1[%arg4, %arg5, %arg8, 0] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<56x16x384x64xf32> to tensor<1x1x64x64xf32>
//         %extracted_slice_6 = tensor.extract_slice %arg2[%arg4, %arg5, %arg8, 0] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<56x16x384x64xf32> to tensor<1x1x64x64xf32>
//         %extracted_slice_7 = tensor.extract_slice %arg3[%arg4, %arg5, %arg6, %arg8] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<56x16x384x384xf32> to tensor<64x64xf32>
//         %collapsed_8 = tensor.collapse_shape %extracted_slice_5 [[0, 1], [2], [3]] : tensor<1x1x64x64xf32> into tensor<1x64x64xf32>
//         %collapsed_9 = tensor.collapse_shape %extracted_slice_6 [[0, 1], [2], [3]] : tensor<1x1x64x64xf32> into tensor<1x64x64xf32>
//         %9 = tensor.empty() : tensor<64x64xf32>
//         %10 = linalg.fill ins(%cst_2 : f32) outs(%9 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %11 = linalg.batch_reduce_matmul ins(%collapsed, %collapsed_8 : tensor<1x64x64xf32>, tensor<1x64x64xf32>) outs(%10 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %12 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%11 : tensor<64x64xf32>) outs(%9 : tensor<64x64xf32>) {
//         ^bb0(%in: f32, %out: f32):
//           %32 = arith.mulf %in, %cst_0 : f32
//           linalg.yield %32 : f32
//         } -> tensor<64x64xf32>
//         %13 = linalg.add ins(%12, %extracted_slice_7 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%9 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %14 = tensor.empty() : tensor<64xf32>
//         %15 = linalg.fill ins(%cst_1 : f32) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %reduced = linalg.reduce ins(%13 : tensor<64x64xf32>) outs(%15 : tensor<64xf32>) dimensions = [1] 
//           (%in: f32, %init: f32) {
//             %32 = arith.maximumf %in, %init : f32
//             linalg.yield %32 : f32
//           }
//         %16 = linalg.max ins(%arg10, %reduced : tensor<64xf32>, tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %broadcasted = linalg.broadcast ins(%16 : tensor<64xf32>) outs(%9 : tensor<64x64xf32>) dimensions = [1] 
//         %17 = linalg.sub ins(%13, %broadcasted : tensor<64x64xf32>, tensor<64x64xf32>) outs(%9 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %18 = linalg.exp ins(%17 : tensor<64x64xf32>) outs(%9 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %expanded_18 = tensor.expand_shape %18 [[0, 1], [2]] output_shape [1, 64, 64] : tensor<64x64xf32> into tensor<1x64x64xf32>
//         %19 = linalg.fill ins(%cst_2 : f32) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %reduced_11 = linalg.reduce ins(%18 : tensor<64x64xf32>) outs(%19 : tensor<64xf32>) dimensions = [1] 
//           (%in: f32, %init: f32) {
//             %32 = arith.addf %in, %init : f32
//             linalg.yield %32 : f32
//           }
//         %20 = linalg.sub ins(%arg10, %16 : tensor<64xf32>, tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %21 = linalg.exp ins(%20 : tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %22 = linalg.mul ins(%arg11, %21 : tensor<64xf32>, tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %23 = linalg.add ins(%reduced_11, %22 : tensor<64xf32>, tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %24 = linalg.reciprocal ins(%23 : tensor<64xf32>) outs(%14 : tensor<64xf32>) -> tensor<64xf32>
//         %25 = tensor.empty() : tensor<64x64xf32>
//         %26 = linalg.fill ins(%cst_2 : f32) outs(%25 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %27 = linalg.batch_reduce_matmul ins(%expanded_18, %collapsed_9 : tensor<1x64x64xf32>, tensor<1x64x64xf32>) outs(%26 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %broadcasted_12 = linalg.broadcast ins(%24 : tensor<64xf32>) outs(%25 : tensor<64x64xf32>) dimensions = [1] 
//         %broadcasted_13 = linalg.broadcast ins(%22 : tensor<64xf32>) outs(%25 : tensor<64x64xf32>) dimensions = [1] 
//         %28 = linalg.mul ins(%27, %broadcasted_12 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%26 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %29 = linalg.mul ins(%broadcasted_13, %broadcasted_12 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%26 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %30 = linalg.mul ins(%arg9, %29 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%26 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         %31 = linalg.add ins(%30, %28 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%25 : tensor<64x64xf32>) -> tensor<64x64xf32>
//         scf.yield %31, %16, %23 : tensor<64x64xf32>, tensor<64xf32>, tensor<64xf32>
//       }
//       scf.forall.in_parallel {
//         tensor.parallel_insert_slice %7#0 into %arg7[%arg4, %arg5, %arg6, 0] [1, 1, 64, 64] [1, 1, 1, 1] : tensor<64x64xf32> into tensor<56x16x384x64xf32>
//       }
//     }
