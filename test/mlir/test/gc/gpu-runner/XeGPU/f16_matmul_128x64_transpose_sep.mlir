...
func.func @linalg_matmul(%arg0: tensor<128x256xf16>,
  ...
  %t = tensor.empty() : tensor<256x64xf16>
  %0 = linalg.transpose ins(%arg1 : tensor<64x256xf16>) outs(%t: tensor<256x64xf16>) permutation = [1, 0]
  %1 = linalg.matmul ins(%arg0, %0 : tensor<128x256xf16>, tensor<256x64xf16>)
                     outs(%arg2 : tensor<128x64xf16>) -> tensor<128x64xf16>
  return %1 : tensor<128x64xf16>
}
