...
module @gemm attributes {gpu.container_module} {
  func.func @test(%src : memref<8x16xf32>) -> memref<8x16xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch blocks(%arg10, %arg11, %arg12) in (%arg16 = %c1, %arg17 = %c1, %arg18 = %c1) threads(%arg13, %arg14, %arg15) in (%arg19 = %c16, %arg20 = %c1, %arg21 = %c1) {
      ...
      %loaded = xevm.blockload2d %src_ptr_casted, %base_width, %base_height, %base_pitch, %x, %y {elem_size_in_bits=32, tile_width=16, tile_height=8, v_blocks=1, transpose=false, vnni_transform=false, l1_cache_control=Default, l3_cache_control=Default} : (!llvm.ptr<1>, i32, i32, i32, i32, i32) -> vector<8xi32>
      ...
      xevm.blockstore2d %dst_ptr_casted, %base_width, %base_height, %base_pitch, %x, %y, %loaded_modified {elem_size_in_bits=32, tile_width=16, tile_height=8, v_blocks=1, l1_cache_control=Default, l3_cache_control=Default} : (!llvm.ptr<1>, i32, i32, i32, i32, i32, vector<8xi32>)
      gpu.terminator
    }
