...
// get upper/lower
inline uint64_t uint128_t::upper_64() const { return (*this).upper_64_; }
inline uint64_t uint128_t::lower_64() const { return (*this).lower_64_; }
// get constant
inline constexpr uint128_t uint128_t::one() { return uint128_t(UINT64_C(1)); }
inline constexpr uint128_t uint128_t::zero() { return uint128_t(UINT64_C(0)); }
...
uint128_t uint128_t::operator<<(const int bits) const {
  ...
  if (bits == 0) {
    ...
    upper = ((*this).upper_64_ << bits) | ((*this).lower_64_ >> (64 - bits));
...
uint128_t uint128_t::operator>>(const int bits) const {
  ...
  if (bits == 0) {
    ...
    lower = ((*this).lower_64_ >> bits) | ((*this).upper_64_ << (64 - bits));
  }
  return uint128_t(upper, lower);
}
uint128_t &uint128_t::operator>>=(int bits) {
...
uint128_t uint128_t::mul_impl(const uint128_t &lhs,
...
uint128_t::qr_pair uint128_t::div_mod_impl(const uint128_t &lhs,
                                           const uint128_t &rhs) const {
  if (rhs == zero()) {
