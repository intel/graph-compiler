...
public:
  ...
  infer_out_dims(sc_graph_t &owner_graph, const sc_dims &input_dims,
                 ...
                 const sc_dims &pads_end, const sc_dims &stride,
                 const sc_dims &dilation, const any_map_t &attrs = {});
  static void infer_auto_pad(sc_graph_t &owner_graph, const sc_dims &input_dims,
                             const sc_dims &weight_dims, const sc_dims &stride,
                             const sc_dims &dilation, any_map_t &attrs,
  ...
  get_s8s8_and_weight_compensation(sc_graph_t &g, bool s8s8_compensation);
