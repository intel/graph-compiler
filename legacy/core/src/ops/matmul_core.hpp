...
public:
  ...
  static sc_dims get_batch_dims_with_bc_impl(const sc_dims &, const sc_dims &);

  static sc_data_type_t infer_out_dtype(const std::vector<graph_tensor_ptr> &);
  ...
  static shape_rl_vec get_shape_relations_impl(const sc_dims &data_plain_dims,
                                               const sc_dims &weight_plain_dims,
