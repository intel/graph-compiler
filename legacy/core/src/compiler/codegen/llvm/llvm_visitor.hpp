...
public:
  ...
  void set_dbg_info_for_func_arg(llvm::Value *v, llvm::DISubprogram *SP,
                                 llvm::DIFile *dunit, sc_data_type_t type,
                                 const std::string &name, int argidx,
                                 int lineno, bool need_ref);
  ...
  llvm::Value *call_unary_llvm_intrin(const intrin_call_c &v,
                                      type_category cate,
                                      llvm::Intrinsic::ID id, bool must_fp);
  ...
  llvm::Value *call_binary_llvm_normal(const intrin_call_c &v,
                                       llvm_binary_func op);

  llvm::Value *make_int_min_max(const intrin_call_c &v, bool ismin,
                                type_category cate);

  llvm::Value *make_int_min_max(llvm::Value *v1, llvm::Value *v2, bool ismin,
                                type_category cate);
  ...
  void generate_codeblock(const stmt_c &v, llvm::BasicBlock *current,
  ...
  void set_dbg_info_for_local_var(const source_pos *pos, sc_data_type_t type,
                                  ...
                                  llvm::Value *llvm_value, bool need_ref);
