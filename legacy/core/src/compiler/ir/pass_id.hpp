...
struct tir_pass_dependency_t {
  ...
  tir_pass_dependency_t(tir_pass::pass_id id = tir_pass::pass_id::undef,
                        ...
                        uint64_t required_state = 0,
                        uint64_t required_not_state = 0, uint64_t set_state = 0,
                        uint64_t unset_state = 0)
      : id_(id), depending_(depending), required_state_(required_state),
        required_not_state_(required_not_state), set_state_(set_state),
