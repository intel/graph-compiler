...
void ir_viewer_t::view(binary_c v) { ir_visitor_t::visit(std::move(v)); }

void ir_viewer_t::view(logic_c v) { ir_visitor_t::visit(std::move(v)); }

void ir_viewer_t::view(cmp_c v) { ir_visitor_t::visit(std::move(v)); }
