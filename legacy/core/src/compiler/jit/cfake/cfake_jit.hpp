...
class SC_INTERNAL_API cfake_jit_module_code_t : public jit_module_code {
  ...
  cfake_jit_module_code_t(void *module, const std::string &src_path,
      ...
      : jit_module_code(managed_thread_pool), module_(module), path_(path),
        src_path_(src_path) {}
...
public:
  ...
  statics_table_t codegen_to_cpp(std::ostream &os, const_ir_module_ptr &new_mod,
                                 const const_ir_module_ptr &module,
                                 bool generate_wrapper);
  statics_table_t
  codegen_to_cpp(std::ostream &os, const_ir_module_ptr &new_mod,
  ...
  std::shared_ptr<jit_module> make_jit_module(const_ir_module_ptr module,
                                              bool generate_wrapper) override;
  std::shared_ptr<jit_module>
  make_jit_module(const std::string &inpath, const std::string &outpath,
