 ...
 **/
using op_content_t =
    variant<int64_t, Xbyak::Address, Xbyak::Reg, Xbyak::Reg8, Xbyak::Reg16,
            Xbyak::Reg32, Xbyak::Reg64, Xbyak::Xmm, Xbyak::Ymm, Xbyak::Zmm,
            Xbyak::Tmm, Xbyak::Opmask>;

using op_ptr_t = std::shared_ptr<op_content_t>;

template <typename T> op_ptr_t wrap_op_ptr(T op) {
...
public:
  ...
  template <typename RegT> explicit operand(RegT reg);
