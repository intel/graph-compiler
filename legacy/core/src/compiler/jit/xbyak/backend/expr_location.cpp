...
expr_location::type expr_location::get_type() const { return type_; }

x86_64::cpu_data_type expr_location::get_data_type() const {
  return data_type_;
}

op_ptr_t expr_location::get_op_ptr() const { return content_; }
...
int64_t expr_location::get_stack_tensor() const {
  COMPILE_ASSERT(type_ == type::stack_tensor,
                 "Not a stack_tensor: " << (*this));
  return content_->as<int64_t>();
}
...
const Xbyak::Address &expr_location::get_simd_constant() const {
  COMPILE_ASSERT(type_ == type::simd_constant,
                 "Not a simd_constant: " << (*this));
...
expr_location expr_location::make_reg(RegT reg,
                                      x86_64::cpu_data_type cpu_dtype) {
  return expr_location(type::reg, cpu_dtype, std::move(reg));
}

expr_location expr_location::make_imm(int64_t imm,
                                      x86_64::cpu_data_type cpu_dtype) {
  return expr_location(type::imm, cpu_dtype, imm);
}

expr_location expr_location::make_stack_var(int64_t offset,
                                            x86_64::cpu_data_type cpu_dtype) {
...
expr_location
expr_location::make_simd_constant(Xbyak::Address addr,
                                  x86_64::cpu_data_type cpu_dtype) {
...
template expr_location
expr_location::make_reg<Xbyak::Reg>(Xbyak::Reg reg,
                                    x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Reg8>(Xbyak::Reg8 reg,
                                     x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Reg16>(Xbyak::Reg16 reg,
                                      x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Reg32>(Xbyak::Reg32 reg,
                                      x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Reg64>(Xbyak::Reg64 reg,
                                      x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Xmm>(Xbyak::Xmm reg,
                                    x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Ymm>(Xbyak::Ymm reg,
                                    x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Zmm>(Xbyak::Zmm reg,
                                    x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Tmm>(Xbyak::Tmm reg,
                                    x86_64::cpu_data_type cpu_dtype);
template expr_location
expr_location::make_reg<Xbyak::Opmask>(Xbyak::Opmask reg,
                                       x86_64::cpu_data_type cpu_dtype);
...
std::ostream &operator<<(std::ostream &os, const expr_location &v) {
  ...
  case expr_location::type::simd_constant: {
    os << "[simd_constant: %rip+.L" << v.get_simd_constant().getLabel()->getId()
       << "]";
  } break;
  }
  return os;
