...
public:
  ...
  operand get_operand_sib(const expr_c &base, const expr_c &indx,
                          const expr_c &disp);
  ...
  size_t get_tensor_slot_size(x86_64::cpu_data_type data_type,
  ...
  get_address_frame(const x86_64::cpu_data_type cpu_dtype);
...
private:
  ...
  Xbyak::Address get_address(const Xbyak::RegExp &exp,
                             x86_64::cpu_data_type cpu_dtype);
  Xbyak::Address get_address(const Xbyak::RegRip &rxp,
                             x86_64::cpu_data_type cpu_dtype);
  // %rbp + offset
  ...
  Xbyak::Address get_offset_address(const int64_t &offset,
                                    x86_64::cpu_data_type cpu_dtype);
  // AddressFrame[%rip + label]
  Xbyak::Address get_offset_address(const Xbyak::Label &label,
                                    x86_64::cpu_data_type cpu_dtype);
