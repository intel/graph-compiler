...
struct xbyak_intrin_modifier {
  ...
  xbyak_intrin_modifier()
      : cond_code_(xbyak_condition::none), type_hint_(datatypes::undef),
        zero_mask_(false), enabled_(false) {}
  xbyak_intrin_modifier(sc_data_type_t type_hint)
      : cond_code_(xbyak_condition::none), type_hint_(type_hint),
        zero_mask_(false), enabled_(true) {}
  xbyak_intrin_modifier(xbyak_condition cond,
                        sc_data_type_t type_hint = datatypes::undef)
      : cond_code_(cond), type_hint_(type_hint), zero_mask_(false),
        enabled_(true) {}
  xbyak_intrin_modifier(expr mask, bool zero = false)
      : cond_code_(xbyak_condition::none), type_hint_(datatypes::undef),
        cond_mask_(mask), zero_mask_(zero), enabled_(true) {}
};
 ...
 * */
expr make_xbyak_intrin(
    sc_data_type_t dtype, const std::vector<expr> &values,
