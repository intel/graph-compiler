...
get_target_profile(const runtime::target_machine_t &target_machine) {
  ...
  if (target_machine.cpu_flags_.fAVX512F) {
    ...
    profile.alloc_mask_regs_ = {
        regs::k1, regs::k2, regs::k3, regs::k4, regs::k5, regs::k6, regs::k7,
    };
  }
  ...
  if (target_machine.cpu_flags_.fAVX512AMXTILE) {
    profile.alloc_tile_regs_ = {
        regs::tmm0, regs::tmm1, regs::tmm2, regs::tmm3,
        regs::tmm4, regs::tmm5, regs::tmm6, regs::tmm7,
    };
  }
  ...
  profile.callee_saved_gp_regs_ = {
      regs::rbx, regs::r12, regs::r13, regs::r14, regs::r15,
  };
  ...
  // Function call save regs
  profile.caller_saved_gp_regs_ = {
      regs::rax, regs::rcx, regs::rdx, regs::r8, regs::r9, regs::r10, regs::r11,
  };
  profile.callee_saved_gp_regs_ = {
      regs::rbx, regs::rdi, regs::rsi, regs::r12,
      regs::r13, regs::r14, regs::r15,
  };
  profile.callee_saved_xmm_regs_ = {
      regs::xmm6,  regs::xmm7,  regs::xmm8,  regs::xmm9,  regs::xmm10,
      regs::xmm11, regs::xmm12, regs::xmm13, regs::xmm14, regs::xmm15,
  };
#else
