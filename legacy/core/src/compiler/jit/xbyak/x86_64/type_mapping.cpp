...
cpu_data_type get_cpu_data_type(sc_data_type_t t) {
  ...
  if (t.lanes_ == 1) {
    if (etypes::is_pointer(e)) {
      return cpu_data_type::uint_64;
    }

    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::uint_8;
    case sc_data_etype::U8:
      return cpu_data_type::uint_8;
    case sc_data_etype::S8:
      return cpu_data_type::sint_8;
    case sc_data_etype::U16:
      return cpu_data_type::uint_16;
    case sc_data_etype::U32:
      return cpu_data_type::uint_32;
    case sc_data_etype::S32:
      return cpu_data_type::sint_32;
    case sc_data_etype::BF16:
      return cpu_data_type::uint_16;
    case sc_data_etype::F16:
      return cpu_data_type::float_16;
    case sc_data_etype::F32:
      return cpu_data_type::float_32;
    ...
    switch (e) {
    case sc_data_etype::S32:
      return cpu_data_type::sint_32_x2;
    case sc_data_etype::U32:
      return cpu_data_type::uint_32_x2;
    case sc_data_etype::F32:
      return cpu_data_type::float_32_x2;
    case sc_data_etype::INDEX:
      return cpu_data_type::uint_64_x2;
    default: // to prevent compiler warnings
      break;
    }
  } else if (t.lanes_ == 4) {
    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::mask_x4;
    case sc_data_etype::BF16:
      return cpu_data_type::uint_16_x4;
    case sc_data_etype::U16:
      return cpu_data_type::uint_16_x4;
    case sc_data_etype::U32:
      return cpu_data_type::uint_32_x4;
    case sc_data_etype::S32:
      return cpu_data_type::sint_32_x4;
    case sc_data_etype::F16:
      return cpu_data_type::float_16_x4;
    case sc_data_etype::F32:
      return cpu_data_type::float_32_x4;
    case sc_data_etype::INDEX:
      return cpu_data_type::uint_64_x4;
    default: // to prevent compiler warnings
      break;
    }
  } else if (t.lanes_ == 8) {
    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::mask_x8;
    case sc_data_etype::U8:
      return cpu_data_type::uint_8_x8;
    case sc_data_etype::S8:
      return cpu_data_type::sint_8_x8;
    case sc_data_etype::BF16:
      return cpu_data_type::uint_16_x8;
    case sc_data_etype::U16:
      return cpu_data_type::uint_16_x8;
    case sc_data_etype::U32:
      return cpu_data_type::uint_32_x8;
    case sc_data_etype::S32:
      return cpu_data_type::sint_32_x8;
    case sc_data_etype::F16:
      return cpu_data_type::float_16_x8;
    case sc_data_etype::F32:
      return cpu_data_type::float_32_x8;
    case sc_data_etype::INDEX:
      return cpu_data_type::uint_64_x8;
    default: // to prevent compiler warnings
      break;
    }
  } else if (t.lanes_ == 16) {
    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::mask_x16;
    case sc_data_etype::U8:
      return cpu_data_type::uint_8_x16;
    case sc_data_etype::S8:
      return cpu_data_type::sint_8_x16;
    case sc_data_etype::U16:
      return cpu_data_type::uint_16_x16;
    case sc_data_etype::U32:
      return cpu_data_type::uint_32_x16;
    case sc_data_etype::S32:
      return cpu_data_type::sint_32_x16;
    case sc_data_etype::BF16:
      return cpu_data_type::uint_16_x16;
    case sc_data_etype::F16:
      return cpu_data_type::float_16_x16;
    case sc_data_etype::F32:
      return cpu_data_type::float_32_x16;
    default: // to prevent compiler warnings
      break;
    }
  } else if (t.lanes_ == 32) {
    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::mask_x32;
    case sc_data_etype::BF16:
      return cpu_data_type::uint_16_x32;
    case sc_data_etype::F16:
      return cpu_data_type::float_16_x32;
    case sc_data_etype::U16:
      return cpu_data_type::uint_16_x32;
    case sc_data_etype::U8:
      return cpu_data_type::uint_8_x32;
    case sc_data_etype::S8:
      return cpu_data_type::sint_8_x32;
    default: // to prevent compiler warnings
      break;
    }
  } else if (t.lanes_ == 64) {
    switch (e) {
    case sc_data_etype::BOOLEAN:
      return cpu_data_type::mask_x64;
    case sc_data_etype::U8:
      return cpu_data_type::uint_8_x64;
    case sc_data_etype::S8:
      return cpu_data_type::sint_8_x64;
    default: // to prevent compiler warnings
      break;
    }
  }
