...
#ifdef __AVX512F__
  static INLINE void mask_store(int8_t *p, __mmask32 mask, vec_s8x32 const &a) {
...
INLINE vec_s8x32 sc_select(__mmask32 mask, vec_s8x32 const &a,
                           vec_s8x32 const &b) {
...
INLINE vec_s8x32 sc_abs(vec_s8x32 const &a) { return _mm256_abs_epi8(a.v); }
#endif
