...
public:
  ...
  static INLINE void store(vec_f16x8 v, _Float16 *p) { _mm_storeu_ph(p, v.v); }
...
INLINE vec_f16x8 sc_select(__mmask8 mask, vec_f16x8 const &a,
                           vec_f16x8 const &b) {
  return _mm_mask_blend_ph(mask, b.v, a.v);
}

INLINE vec_f16x8 sc_fmadd(vec_f16x8 const &a, vec_f16x8 const &b,
                          vec_f16x8 const &c) {
  return _mm_fmadd_ph(a.v, b.v, c.v);
}

INLINE vec_f16x8 sc_fnmadd(vec_f16x8 const &a, vec_f16x8 const &b,
                           vec_f16x8 const &c) {
...
INLINE vec_f16x8 sc_sqrt(vec_f16x8 const &a) { return _mm_sqrt_ph(a.v); }
INLINE vec_f16x8 sc_rsqrt(vec_f16x8 const &a) { return _mm_rsqrt_ph(a.v); }
