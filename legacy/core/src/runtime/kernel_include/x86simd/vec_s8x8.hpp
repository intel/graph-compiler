...
public:
  ...
  // }
#ifdef __AVX512F__
  static INLINE void mask_store(int8_t *p, __mmask8 mask8, vec_s8x8 const &a) {
    __mmask16 mask16 = 0x00FF; // Initialize the 16-bit mask to higher bits
                               // 0's (initially unmasked)
...
INLINE vec_s8x8 sc_select(__mmask8 mask8, vec_s8x8 const &a,
                          vec_s8x8 const &b) {
  __mmask16 mask16 = 0x00FF; // Initialize the 16-bit mask to higher bits
                             // 0's (initially unmasked)
...
INLINE vec_s8x8 sc_abs(vec_s8x8 const &a) { return _mm_abs_epi8(a.v); }
#endif
