...
public:
  ...
  INLINE vec_u16x16(uint16_t i0, uint16_t i1, uint16_t i2, uint16_t i3,
                    ...
                    uint16_t i8, uint16_t i9, uint16_t i10, uint16_t i11,
                    uint16_t i12, uint16_t i13, uint16_t i14, uint16_t i15) {
    v = _mm256_setr_epi16(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                          i13, i14, i15);
  }
...
#ifdef __AVX512F__
  static INLINE void mask_store(uint16_t *p, __mmask16 mask,
                                vec_u16x16 const &a) {
...
INLINE vec_u16x16 sc_select(__mmask16 mask, vec_u16x16 const &a,
                            vec_u16x16 const &b) {
...
INLINE vec_u16x16 sc_unpack_low_vec_u16x16_16bits(vec_u16x16 const &a,
                                                  vec_u16x16 const &b) {
  return _mm256_unpacklo_epi16(a.v, b.v);
}
INLINE vec_u16x16 sc_unpack_high_vec_u16x16_16bits(vec_u16x16 const &a,
                                                   vec_u16x16 const &b) {
  return _mm256_unpackhi_epi16(a.v, b.v);
}
INLINE vec_u16x16 sc_unpack_low_vec_u16x16_32bits(vec_u16x16 const &a,
                                                  vec_u16x16 const &b) {
  return _mm256_unpacklo_epi32(a.v, b.v);
}
INLINE vec_u16x16 sc_unpack_high_vec_u16x16_32bits(vec_u16x16 const &a,
                                                   vec_u16x16 const &b) {
  return _mm256_unpackhi_epi32(a.v, b.v);
}
INLINE vec_u16x16 sc_unpack_low_vec_u16x16_64bits(vec_u16x16 const &a,
                                                  vec_u16x16 const &b) {
  return _mm256_unpacklo_epi64(a.v, b.v);
}
INLINE vec_u16x16 sc_unpack_high_vec_u16x16_64bits(vec_u16x16 const &a,
                                                   vec_u16x16 const &b) {
