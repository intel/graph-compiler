...
public:
  ...
  INLINE vec_s8x16(int8_t i0, int8_t i1, int8_t i2, int8_t i3, int8_t i4,
                   int8_t i5, int8_t i6, int8_t i7, int8_t i8, int8_t i9,
                   int8_t i10, int8_t i11, int8_t i12, int8_t i13, int8_t i14,
                   int8_t i15) {
...
#ifdef __AVX512F__
  static INLINE void mask_store(int8_t *p, __mmask16 mask, vec_s8x16 const &a) {
...
INLINE vec_s8x16 sc_select(__mmask16 mask, vec_s8x16 const &a,
                           vec_s8x16 const &b) {
...
INLINE vec_s8x16 sc_unpack_low_vec_s8x16_8bits(vec_s8x16 const &a,
                                               vec_s8x16 const &b) {
  return _mm_unpacklo_epi8(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_low_vec_s8x16_16bits(vec_s8x16 const &a,
                                                vec_s8x16 const &b) {
  return _mm_unpacklo_epi16(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_low_vec_s8x16_32bits(vec_s8x16 const &a,
                                                vec_s8x16 const &b) {
  return _mm_unpacklo_epi32(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_low_vec_s8x16_64bits(vec_s8x16 const &a,
                                                vec_s8x16 const &b) {
  return _mm_unpacklo_epi64(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_high_vec_s8x16_8bits(vec_s8x16 const &a,
                                                vec_s8x16 const &b) {
  return _mm_unpackhi_epi8(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_high_vec_s8x16_16bits(vec_s8x16 const &a,
                                                 vec_s8x16 const &b) {
  return _mm_unpackhi_epi16(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_high_vec_s8x16_32bits(vec_s8x16 const &a,
                                                 vec_s8x16 const &b) {
  return _mm_unpackhi_epi32(a.v, b.v);
}

INLINE vec_s8x16 sc_unpack_high_vec_s8x16_64bits(vec_s8x16 const &a,
                                                 vec_s8x16 const &b) {
...
INLINE vec_s8x16 sc_abs(vec_s8x16 const &a) { return _mm_abs_epi8(a.v); }
#endif
