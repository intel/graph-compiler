...
public:
  ...
  static INLINE void store(vec_f16x4 v, _Float16 *p) { _mm_storeu_ph(p, v.v); }
  ...
  static INLINE void mask_store(_Float16 *p, __mmask8 mask,
                                vec_f16x4 const &a) {
...
INLINE vec_f16x4 sc_select(__mmask8 mask, vec_f16x4 const &a,
                           vec_f16x4 const &b) {
  return _mm_mask_blend_ph(mask, b.v, a.v);
}

INLINE vec_f16x4 sc_fmadd(vec_f16x4 const &a, vec_f16x4 const &b,
                          vec_f16x4 const &c) {
  return _mm_fmadd_ph(a.v, b.v, c.v);
}

INLINE vec_f16x4 sc_fnmadd(vec_f16x4 const &a, vec_f16x4 const &b,
                           vec_f16x4 const &c) {
...
INLINE vec_f16x4 sc_round(vec_f16x4 const &a) {
  return _mm_roundscale_ph(a.v, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC);
}
...
INLINE vec_f16x4 sc_sqrt(vec_f16x4 const &a) { return _mm_sqrt_ph(a.v); }
INLINE vec_f16x4 sc_rsqrt(vec_f16x4 const &a) { return _mm_rsqrt_ph(a.v); }
