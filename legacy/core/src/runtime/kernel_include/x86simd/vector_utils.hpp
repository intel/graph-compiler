...
template <> INLINE vec_s32x4 sc_round_and_cast(const vec_f32x4 &x) {
  return _mm_cvtps_epi32(x.v);
}

INLINE vec_f32x4::operator vec_s32x4() const { return _mm_cvttps_epi32(v); }

INLINE vec_s32x4::operator vec_f32x4() const { return _mm_cvtepi32_ps(v); }

#ifdef __AVX__
template <> INLINE vec_s32x8 sc_round_and_cast(const vec_f32x8 &x) {
  return _mm256_cvtps_epi32(x.v);
}

INLINE vec_s32x8::operator vec_f32x8() const { return _mm256_cvtepi32_ps(v); }

INLINE vec_f32x8::operator vec_s32x8() const { return _mm256_cvttps_epi32(v); }
#endif
...
INLINE vec_s32x16::operator vec_f32x16() const { return _mm512_cvtepi32_ps(v); }
...
INLINE vec_u32x4::operator vec_u16x4() const { return _mm_cvtepi32_epi16(v); }
...
INLINE vec_f16x16::operator vec_u16x16() const { return _mm256_cvtph_epu16(v); }
INLINE vec_f16x16::operator vec_f32x16() const { return _mm512_cvtxph_ps(v); }
INLINE vec_f16x8::operator vec_f32x8() const { return _mm256_cvtxph_ps(v); }
INLINE vec_f16x16::operator vec_u32x16() const { return _mm512_cvtph_epu32(v); }
INLINE vec_f16x16::operator vec_s32x16() const { return _mm512_cvtph_epi32(v); }
INLINE vec_f32x16::operator vec_f16x16() const { return _mm512_cvtxps_ph(v); }
INLINE vec_f32x8::operator vec_f16x8() const { return _mm256_cvtxps_ph(v); }
INLINE vec_u16x16::operator vec_f16x16() const { return _mm256_cvtepu16_ph(v); }
INLINE vec_s32x16::operator vec_f16x16() const { return _mm512_cvtepi32_ph(v); }
INLINE vec_u32x16::operator vec_f16x16() const { return _mm512_cvtepu32_ph(v); }
#endif
...
#endif
template <> INLINE vec_s32x16 sc_round_and_cast(const vec_f32x16 &x) {
  return _mm512_cvtps_epi32(x.v);
}
template <> INLINE vec_u32x16 sc_round_and_cast(const vec_f32x16 &x) {
  return _mm512_cvtps_epu32(x.v);
}

// saturated cast
template <> INLINE vec_s8x16 sc_saturated_cast(const vec_s32x16 &x) {
  return _mm512_cvtsepi32_epi8(x.v);
}

template <> INLINE vec_u8x16 sc_saturated_cast(const vec_s32x16 &x) {
