...
public:
  ...
  static INLINE vec_f16x32 mask_load(const _Float16 *p, __mmask32 mask) {
    ...
    __m512i load_512b_data = _mm512_mask_loadu_epi16(vec_u16x32(0).v, mask, p);
    return _mm512_cvtepi16_ph(load_512b_data);
  }
  static INLINE void mask_store(_Float16 *p, __mmask32 mask,
                                vec_f16x32 const &a) {
...
INLINE vec_f16x32 sc_select(__mmask32 mask, vec_f16x32 const &a,
                            vec_f16x32 const &b) {
  return _mm512_mask_blend_ph(mask, b.v, a.v);
}

INLINE vec_f16x32 sc_fmadd(vec_f16x32 const &a, vec_f16x32 const &b,
                           vec_f16x32 const &c) {
  return _mm512_fmadd_ph(a.v, b.v, c.v);
}

INLINE vec_f16x32 sc_fnmadd(vec_f16x32 const &a, vec_f16x32 const &b,
                            vec_f16x32 const &c) {
...
INLINE vec_f16x32 sc_round(vec_f16x32 const &a) {
  return _mm512_roundscale_ph(a.v,
...
INLINE vec_f16x32 sc_sqrt(vec_f16x32 const &a) { return _mm512_sqrt_ph(a.v); }
INLINE vec_f16x32 sc_rsqrt(vec_f16x32 const &a) { return _mm512_rsqrt_ph(a.v); }
