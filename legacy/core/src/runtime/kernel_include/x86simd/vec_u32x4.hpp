...
#ifdef __AVX512F__
  static INLINE void mask_store(uint32_t *p, __mmask8 mask,
                                vec_u32x4 const &a) {
...
INLINE vec_u32x4 sc_select(__mmask8 mask, vec_u32x4 const &a,
                           vec_u32x4 const &b) {
...
INLINE vec_u32x4 sc_unpack_low_vec_u32x4_32bits(vec_u32x4 const &a,
                                                vec_u32x4 const &b) {
  return _mm_unpacklo_epi32(a.v, b.v);
}

INLINE vec_u32x4 sc_unpack_high_vec_u32x4_32bits(vec_u32x4 const &a,
                                                 vec_u32x4 const &b) {
