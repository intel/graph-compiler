...
public:
  ...
  INLINE vec_u8x8(uint8_t i0, uint8_t i1, uint8_t i2, uint8_t i3, uint8_t i4,
    ...
    v = _mm_setr_epi8(i0, i1, i2, i3, i4, i5, i6, i7, 0, 0, 0, 0, 0, 0, 0, 0);
  }
  ...
  // }
#ifdef __AVX512F__
  static INLINE void mask_store(uint8_t *p, __mmask8 mask8, vec_u8x8 const &a) {
    __mmask16 mask16 = 0x00FF; // Initialize the 16-bit mask to higher bits
                               // 0's (initially unmasked)
...
INLINE vec_u8x8 sc_select(__mmask8 mask8, vec_u8x8 const &a,
                          vec_u8x8 const &b) {
  __mmask16 mask16 = 0x00FF; // Initialize the 16-bit mask to higher bits
                             // 0's (initially unmasked)
...
INLINE vec_u8x8 sc_abs(vec_u8x8 const &a) { return _mm_abs_epi8(a.v); }
#endif
