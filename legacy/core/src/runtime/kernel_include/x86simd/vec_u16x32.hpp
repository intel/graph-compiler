...
public:
  ...
  static INLINE void mask_store(uint16_t *p, __mmask32 mask,
                                vec_u16x32 const &a) {
...
INLINE vec_u16x32 sc_select(__mmask32 mask, vec_u16x32 const &a,
                            vec_u16x32 const &b) {
...
INLINE vec_u16x32 sc_unpack_low_vec_u16x32_16bits(vec_u16x32 const &a,
                                                  vec_u16x32 const &b) {
  return _mm512_unpacklo_epi16(a.v, b.v);
}

INLINE vec_u16x32 sc_unpack_low_vec_u16x32_32bits(vec_u16x32 const &a,
                                                  vec_u16x32 const &b) {
  return _mm512_unpacklo_epi32(a.v, b.v);
}

INLINE vec_u16x32 sc_unpack_low_vec_u16x32_64bits(vec_u16x32 const &a,
                                                  vec_u16x32 const &b) {
  return _mm512_unpacklo_epi64(a.v, b.v);
}

INLINE vec_u16x32 sc_unpack_high_vec_u16x32_16bits(vec_u16x32 const &a,
                                                   vec_u16x32 const &b) {
  return _mm512_unpackhi_epi16(a.v, b.v);
}
INLINE vec_u16x32 sc_unpack_high_vec_u16x32_32bits(vec_u16x32 const &a,
                                                   vec_u16x32 const &b) {
  return _mm512_unpackhi_epi32(a.v, b.v);
}
INLINE vec_u16x32 sc_unpack_high_vec_u16x32_64bits(vec_u16x32 const &a,
                                                   vec_u16x32 const &b) {
