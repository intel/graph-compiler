...
public:
  ...
  INLINE vec_f16x16(_Float16 i0, _Float16 i1, _Float16 i2, _Float16 i3,
                    ...
                    _Float16 i8, _Float16 i9, _Float16 i10, _Float16 i11,
                    _Float16 i12, _Float16 i13, _Float16 i14, _Float16 i15) {
    v = _mm256_setr_ph(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15);
  }
  ...
  static INLINE void mask_store(_Float16 *p, __mmask16 mask,
                                vec_f16x16 const &a) {
...
INLINE vec_f16x16 sc_select(__mmask16 mask, vec_f16x16 const &a,
                            vec_f16x16 const &b) {
  return _mm256_mask_blend_ph(mask, b.v, a.v);
}

INLINE vec_f16x16 sc_fmadd(vec_f16x16 const &a, vec_f16x16 const &b,
                           vec_f16x16 const &c) {
  return _mm256_fmadd_ph(a.v, b.v, c.v);
}

INLINE vec_f16x16 sc_fnmadd(vec_f16x16 const &a, vec_f16x16 const &b,
                            vec_f16x16 const &c) {
...
INLINE vec_f16x16 sc_round(vec_f16x16 const &a) {
  return _mm256_roundscale_ph(a.v,
...
INLINE vec_f16x16 sc_sqrt(vec_f16x16 const &a) { return _mm256_sqrt_ph(a.v); }
INLINE vec_f16x16 sc_rsqrt(vec_f16x16 const &a) { return _mm256_rsqrt_ph(a.v); }
INLINE vec_f16x16 sc_abs(vec_f16x16 const &a) { return _mm256_abs_ph(a.v); }
