...
public:
  ...
  INLINE vec_s32x16(int32_t i0, int32_t i1, int32_t i2, int32_t i3, int32_t i4,
    ...
    v = _mm512_setr_epi32(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                          i13, i14, i15);
  }
...
INLINE vec_s32x16 sc_select(__mmask16 mask, vec_s32x16 const &a,
                            vec_s32x16 const &b) {
...
INLINE vec_s32x16 sc_abs(vec_s32x16 const &a) { return _mm512_abs_epi32(a.v); }
#endif
#endif
