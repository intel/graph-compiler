...
#ifdef __AVX512F__
  static INLINE void mask_store(uint16_t *p, __mmask8 mask,
                                vec_u16x8 const &a) {
...
INLINE vec_u16x8 sc_select(__mmask8 mask, vec_u16x8 const &a,
                           vec_u16x8 const &b) {
...
INLINE vec_u16x8 sc_unpack_low_vec_u16x8_16bits(vec_u16x8 const &a,
                                                vec_u16x8 const &b) {
  return _mm_unpacklo_epi16(a.v, b.v);
}
INLINE vec_u16x8 sc_unpack_high_vec_u16x8_16bits(vec_u16x8 const &a,
                                                 vec_u16x8 const &b) {
