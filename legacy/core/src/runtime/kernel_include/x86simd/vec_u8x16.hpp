...
public:
  ...
  INLINE vec_u8x16(uint8_t i0, uint8_t i1, uint8_t i2, uint8_t i3, uint8_t i4,
                   ...
                   uint8_t i10, uint8_t i11, uint8_t i12, uint8_t i13,
                   uint8_t i14, uint8_t i15) {
...
#ifdef __AVX512F__
  static INLINE void mask_store(uint8_t *p, __mmask16 mask,
                                vec_u8x16 const &a) {
...
INLINE vec_u8x16 sc_select(__mmask16 mask, vec_u8x16 const &a,
                           vec_u8x16 const &b) {
...
INLINE vec_u8x16 sc_permutex2var(vec_u8x16 const &a, vec_u8x16 const &idx,
                                 vec_u8x16 const &b) {
  return _mm_permutex2var_epi8(a.v, idx.v, b.v);
}
#endif

INLINE vec_u8x16 sc_unpack_low_vec_u8x16_8bits(vec_u8x16 const &a,
                                               vec_u8x16 const &b) {
  return _mm_unpacklo_epi8(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_low_vec_u8x16_16bits(vec_u8x16 const &a,
                                                vec_u8x16 const &b) {
  return _mm_unpacklo_epi16(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_low_vec_u8x16_32bits(vec_u8x16 const &a,
                                                vec_u8x16 const &b) {
  return _mm_unpacklo_epi32(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_low_vec_u8x16_64bits(vec_u8x16 const &a,
                                                vec_u8x16 const &b) {
  return _mm_unpacklo_epi64(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_high_vec_u8x16_8bits(vec_u8x16 const &a,
                                                vec_u8x16 const &b) {
  return _mm_unpackhi_epi8(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_high_vec_u8x16_16bits(vec_u8x16 const &a,
                                                 vec_u8x16 const &b) {
  return _mm_unpackhi_epi16(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_high_vec_u8x16_32bits(vec_u8x16 const &a,
                                                 vec_u8x16 const &b) {
  return _mm_unpackhi_epi32(a.v, b.v);
}

INLINE vec_u8x16 sc_unpack_high_vec_u8x16_64bits(vec_u8x16 const &a,
                                                 vec_u8x16 const &b) {
