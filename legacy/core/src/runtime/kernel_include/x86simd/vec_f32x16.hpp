...
public:
  ...
  INLINE vec_f32x16(float i0, float i1, float i2, float i3, float i4, float i5,
                    float i6, float i7, float i8, float i9, float i10,
                    float i11, float i12, float i13, float i14, float i15) {
    v = _mm512_setr_ps(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15);
  }
  ...
  static INLINE void store(vec_f32x16 v, float *p) { _mm512_storeu_ps(p, v.v); }
  static INLINE void store_aligned(vec_f32x16 v, float *p) {
    _mm512_store_ps(p, v.v);
  }
  static INLINE void mask_store(float *p, __mmask16 mask, vec_f32x16 const &a) {
...
INLINE vec_f32x16 sc_select(__mmask16 mask, vec_f32x16 const &a,
                            vec_f32x16 const &b) {
...
INLINE vec_f32x16 sc_abs(vec_f32x16 const &a) { return _mm512_abs_ps(a.v); }
...
INLINE vec_f32x16 sc_unpack_low_vec_f32x16_32bits(vec_f32x16 const &a,
                                                  vec_f32x16 const &b) {
  return _mm512_unpacklo_ps(a.v, b.v);
}

INLINE vec_f32x16 sc_unpack_low_vec_f32x16_64bits(vec_f32x16 const &a,
                                                  vec_f32x16 const &b) {
  return _mm512_castpd_ps(
      _mm512_unpacklo_pd(_mm512_castps_pd(a.v), _mm512_castps_pd(b.v)));
}

INLINE vec_f32x16 sc_unpack_high_vec_f32x16_32bits(vec_f32x16 const &a,
                                                   vec_f32x16 const &b) {
  return _mm512_unpackhi_ps(a.v, b.v);
}

INLINE vec_f32x16 sc_unpack_high_vec_f32x16_64bits(vec_f32x16 const &a,
                                                   vec_f32x16 const &b) {
  return _mm512_castpd_ps(
