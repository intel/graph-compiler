...
SC_INTERNAL_API logging_stream_t
get_info_logging_stream(const char *module_name = nullptr);
SC_INTERNAL_API logging_stream_t
get_warning_logging_stream(const char *module_name = nullptr);
SC_INTERNAL_API logging_stream_t
get_fatal_logging_stream(const char *module_name = nullptr);
