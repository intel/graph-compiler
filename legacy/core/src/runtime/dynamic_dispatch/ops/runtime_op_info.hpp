...
struct dyn_conv_fwd_runtime_info_t {
  ...
  dyn_conv_fwd_runtime_info_t(int stride_d, int stride_h, int stride_w,
                              int pads_begin_d, int pads_begin_h,
                              int pads_begin_w, int pads_end_d, int pads_end_h,
                              int pads_end_w, int dilation_d, int dilation_h,
                              int dilation_w)
      : stride_d(stride_d), stride_h(stride_h), stride_w(stride_w),
        pads_begin_d(pads_begin_d), pads_begin_h(pads_begin_h),
        pads_begin_w(pads_begin_w), pads_end_d(pads_end_d),
        pads_end_h(pads_end_h), pads_end_w(pads_end_w), dilation_d(dilation_d),
  ...
  dyn_conv_fwd_runtime_info_t(int stride_h, int stride_w, int pads_begin_h,
      ...
      : stride_h(stride_h), stride_w(stride_w), pads_begin_h(pads_begin_h),
        pads_begin_w(pads_begin_w), pads_end_h(pads_end_h),
        pads_end_w(pads_end_w), dilation_h(dilation_h), dilation_w(dilation_w) {
  }
};
...
struct dyn_padding_runtime_info_t {
  ...
  dyn_padding_runtime_info_t(int pads_begin_d, int pads_begin_h,
      ...
      : pads_begin_d(pads_begin_d), pads_begin_h(pads_begin_h),
        pads_begin_w(pads_begin_w), pads_end_d(pads_end_d),
        pads_end_h(pads_end_h), pads_end_w(pads_end_w) {}

  dyn_padding_runtime_info_t(int pads_begin_h, int pads_begin_w, int pads_end_h,
                             int pads_end_w)
      : pads_begin_h(pads_begin_h), pads_begin_w(pads_begin_w),
        pads_end_h(pads_end_h), pads_end_w(pads_end_w) {}
};
...
struct dyn_pooling_runtime_info_t {
  ...
  dyn_pooling_runtime_info_t(int stride_d, int stride_h, int stride_w,
                             int pads_begin_d, int pads_begin_h,
                             int pads_begin_w, int pads_end_d, int pads_end_h,
                             int pads_end_w, int kernel_d, int kernel_h,
                             int kernel_w, bool rounding_type_floor,
                             bool auto_pads_same)
      : stride_d(stride_d), stride_h(stride_h), stride_w(stride_w),
        pads_begin_d(pads_begin_d), pads_begin_h(pads_begin_h),
        pads_begin_w(pads_begin_w), pads_end_d(pads_end_d),
        pads_end_h(pads_end_h), pads_end_w(pads_end_w), kernel_d(kernel_d),
  ...
  dyn_pooling_runtime_info_t(int stride_h, int stride_w, int pads_begin_h,
                             ...
                             bool rounding_type_floor, bool auto_pads_same)
      : stride_h(stride_h), stride_w(stride_w), pads_begin_h(pads_begin_h),
        pads_begin_w(pads_begin_w), pads_end_h(pads_end_h),
        pads_end_w(pads_end_w), kernel_h(kernel_h), kernel_w(kernel_w),
        rounding_type_floor(rounding_type_floor),
        auto_pads_same(auto_pads_same) {}
};
