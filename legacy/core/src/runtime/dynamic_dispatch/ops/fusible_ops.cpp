...
namespace graph {
namespace gc {
static bool is_block_produce_padding(runtime::dynamic_tensor_t *in,
...
static bool is_fast_transpose_padding(runtime::dynamic_tensor_t *in,
  ...
  if (ori_in_dim != ori_out_dim) {
    if (etype == uint32_t(sc_data_etype::F32) &&
        (in->dims_[ori_in_dim] % 8 != 0 || in->dims_[ori_out_dim] % 8 != 0)) {
      return true;
    }
    if (etype == uint32_t(sc_data_etype::BF16) &&
        (in->dims_[ori_in_dim] % 8 != 0 || in->dims_[ori_in_dim] % 32 != 0)) {
      return true;
    }
  }
  return false;
...
extern "C" void
infer_shape_padding_fusible_op(void *out, void *in,
                               dyn_padding_runtime_info_t &op_info) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(in);
...
extern "C" void query_format_binary_fusible_op(
    void *table, void *out, void *in0, void *in1, uint64_t *out_fmt,
    uint64_t *in0_fmt, uint64_t *in1_fmt, uint64_t *out_size, void *kernel) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in0_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(in0);
...
extern "C" void query_format_reorder_op(void *table, void *out, void *in,
                                        uint64_t *out_fmt, uint64_t *in_fmt,
...
extern "C" void query_format_padding_op(void *table, void *out, void *in,
  ...
  dyn_padding_runtime_info_t info =
      *op_table->op_info_.unchecked_get_as<dyn_padding_runtime_info_t>();
  ...
  if (kernel_table) {
    uint64_t keys[2] = {*in_fmt, *out_fmt};
    void *func = op_table->kernel_dispatch_func_(kernel_table.get(), keys, 2);
    assert(func);
    *reinterpret_cast<void **>(kernel) = func;
  }
  // query inplace
...
extern "C" void
infer_shape_pooling_fusible_op(void *out, void *in,
                               dyn_pooling_runtime_info_t &op_info) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(in);
  ...
  if (op_info.auto_pads_same) {
    for (int i = 2; i < data_ndims; i++) {
      out_dyn_tsr->dims_[i] =
          (data_dims[i] + strides[i + offset] - 1) / strides[i + offset];
    }
  } else {
    for (int i = 2; i < data_ndims; i++) {
      if (op_info.rounding_type_floor) {
        out_dyn_tsr->dims_[i] = (data_dims[i] + pads_begin[i + offset] +
                                 pads_end[i + offset] - kernels[i + offset]) /
                                    strides[i + offset] +
                                1;
      } else {
        out_dyn_tsr->dims_[i] =
            utils::divide_and_ceil(data_dims[i] + pads_begin[i + offset] +
                                       pads_end[i + offset] -
                                       kernels[i + offset],
                                   strides[i + offset]) +
            1;
...
extern "C" void query_format_pooling_op(void *table, void *out, void *in,
  ...
  dyn_pooling_runtime_info_t info =
      *op_table->op_info_.unchecked_get_as<dyn_pooling_runtime_info_t>();
...
extern "C" void infer_shape_reduce_op(void *out, void *in, int *rd_axis,
                                      int num_axis) {
...
extern "C" void query_format_select_op(void *table, void *out, void *in0,
                                       void *in1, void *in2, uint64_t *out_fmt,
                                       uint64_t *in0_fmt, uint64_t *in1_fmt,
                                       uint64_t *in2_fmt, uint64_t *out_size,
                                       void *kernel) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in1_dyn_tsr =
...
extern "C" void infer_shape_transpose_op(void *out, void *in, int *tr_axis,
                                         int num_axis) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in_dyn_tsr =
...
extern "C" void infer_shape_tensor_view_op(void *out, void *in,
                                           int64_t *old_axis, int num_old_axis,
                                           int64_t *new_axis,
                                           int num_new_axis) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
...
extern "C" void infer_shape_select_op(void *out, void *in0, void *in1,
                                      void *in2) {
  runtime::dynamic_tensor_t *out_dyn_tsr =
      reinterpret_cast<runtime::dynamic_tensor_t *>(out);
  runtime::dynamic_tensor_t *in0_dyn_tsr =
