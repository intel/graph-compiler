...
sc_aligned_malloc(dnnl::impl::graph::gc::runtime::stream_t *stream,
                  size_t sz) noexcept;
extern "C" SC_API void
sc_aligned_free(dnnl::impl::graph::gc::runtime::stream_t *stream,
                void *p) noexcept;
extern "C" SC_API void *
sc_thread_aligned_malloc(dnnl::impl::graph::gc::runtime::stream_t *stream,
                         size_t sz) noexcept;
extern "C" SC_API void
sc_thread_aligned_free(dnnl::impl::graph::gc::runtime::stream_t *stream,
                       void *p) noexcept;
