...
target_machine_t get_native_target_machine() {
  ...
  if (nIds >= 0x00000007) {
    ...
    tm.cpu_flags_.fAVX2 = tm.cpu_flags_.fAVX && (info[1] & ((int)1 << 5)) != 0;
    ...
    tm.cpu_flags_.fAVX512IFMA = hasavx512 && (info[1] & ((int)1 << 21)) != 0;
    tm.cpu_flags_.fAVX512VNNI = hasavx512 && (info[2] & ((int)1 << 11)) != 0;
    tm.cpu_flags_.fAVX512AMXBF16 = hasavx512 && (info[3] & ((int)1 << 22)) != 0;
    tm.cpu_flags_.fAVX512FP16 = hasavx512 && (info[3] & ((int)1 << 23)) != 0;
    tm.cpu_flags_.fAVX512AMXTILE = hasavx512 && (info[3] & ((int)1 << 24)) != 0;
    tm.cpu_flags_.fAVX512AMXINT8 = hasavx512 && (info[3] & ((int)1 << 25)) != 0;
  ...
  for (int i = 0; tm.cpu_flags_.dataCacheLevels_ <
    ...
    tm.cpu_flags_.dataCacheSize_[tm.cpu_flags_.dataCacheLevels_] =
        (extractBit(info[1], 22, 31) + 1) * (extractBit(info[1], 12, 21) + 1) *
