...
inline void insertArgs(std::ostream &stream) { stream << std::endl; }

template <typename T, typename... Args>
void insertArgs(std::ostream &stream, T first, Args... args) {
  stream << first;
...
inline bool isDebugEnabled(const char *fileName) {
...
template <typename... Args>
void debug(const char *fileName, int lineNum, Args... args) {
