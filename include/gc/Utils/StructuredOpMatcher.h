//===-- StructuredOpMatcher.h - Utils for structuterd Op --------*- C++ -*-===//
//
 ...
 * https://github.com/plaidml/tpp-mlir/tree/main/include/TPP/IR/StructuredOpMatcher.h
 */
...
struct NumAffineMaps {
  ...
  explicit NumAffineMaps(std::function<bool(size_t)> fun)
      : fun(std::move(fun)){};
