...
export LD_PRELOAD="/home/xiaohui/miniforge3/envs/pytorch/lib/libiomp5.so ${PROJECT_DIR}/build/lib/libGCCpuRuntime.so /home/xiaohui/miniforge3/envs/pytorch/lib/libjemalloc.so"
