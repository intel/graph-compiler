...
static std::deque<brgemm_desc_t> g_brgemm_desc_list;
static std::deque<brgemm_kernel_t *> g_brgemm_kernel_list;
static std::deque<std::unique_ptr<char[]>> g_brgemm_palette;
