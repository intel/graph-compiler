...
#ifndef COMPILER_DIALECT_LINALGEXT_UTILS_INDEXINGUTILS_H_
#define COMPILER_DIALECT_LINALGEXT_UTILS_INDEXINGUTILS_H_
...
#endif // COMPILER_DIALECT_LINALGEXT_UTILS_INDEXINGUTILS_H_
